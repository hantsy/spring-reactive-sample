...
1. Basic ServerHttpSecurity configuration and examples
2. Reactive form and token auth patterns
3. Method-level security and testing
4. Integration with Spring Session and external identity providers
