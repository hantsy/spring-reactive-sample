...
@EnableMongoAuditing
public class FuntionalDemoApplication {

    public static void main(String[] args) {
        SpringApplication.run(FuntionalDemoApplication.class, args);
    }
...
class PostHandler {
    ...
    public Mono<ServerResponse> create(ServerRequest req) {
        return req.bodyToMono(Post.class)
            ...
            .flatMap(p -> ServerResponse.created(URI.create(req.uri().toString() + '/' + p.getId())).build());
    }
